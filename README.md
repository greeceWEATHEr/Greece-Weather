...
async function showHistoryHourly(
    ...
    hourlyBox.innerHTML = `
        ...
        <div class="history-hourly-loading">

            Φόρτωση ωριαίων ιστορικών δεδομένων...
...
function formatHistoryDateOnly(
    dateString
){
